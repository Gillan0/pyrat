...
from djikstra import find_route, locations_to_actions
...
def traversal ( source:             int,
    ...
    not_found_target = True

    closest_cheese = -1

    while stack != empty_stack and not_found_target:
        ...
        if current_vertex not in visited :
            ...
            if current_vertex in targets:
                not_found_target = False
                closest_cheese = current_vertex
            else:
    ...
    return distance_to_explored_vertices, routing_table, closest_cheese
...
def djikstra ( source: int,
    ...
    distances_to_explored_vertices, routing_table, closest_cheese = traversal(source, graph, _create_structure, _push_to_structure, _pop_from_structure, targets)
    return distances_to_explored_vertices, routing_table, closest_cheese
...
def preprocessing ( maze:             Union[numpy.ndarray, Dict[int, Dict[int, int]]],
    ...
    memory.targets : List[int] = cheese
...
def turn ( maze:             Union[numpy.ndarray, Dict[int, Dict[int, int]]],
    ...
    if memory.actions == [] :
        ...
        distances_to_explored_vertices, routing_table, closest_cheese = djikstra(current_vertex, maze, cheese)

        route = find_route(routing_table,current_vertex, closest_cheese)
