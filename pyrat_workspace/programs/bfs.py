...
def preprocessing ( maze:             Union[numpy.ndarray, Dict[int, Dict[int, int]]],
    ...
    distance_to_vertices, routing_table = bfs(starting_point,maze)
...
testing_graph_1 : Dict[int,Dict[int,int]] = {0 : {1 : 1, 2 : 1, 3 : 1},
                                            1 : {0 : 1}, 2 : {0 : 1, 4 : 1},
                                            3 : {0 : 1, 4 : 1},
                                            4 : {2 : 1, 3 : 1, 5 : 1},
                                            5 : {4 : 1}}

testing_graph_2 : Dict[int,Dict[int,int]] = {0 : {1 : 1, 2 : 1, 3 : 1, 4 : 1},
                                            1 : {0 : 1, 4 : 1, 5 : 1},
                                            2 : {0 : 1, 3 : 1},
                                            3 : {0 : 1, 2 : 1, 6 : 1},
                                            4 : {0 : 1, 1 : 1},
...
testing_distance_to_vertices_1 = {0:0, 1:1, 2:1, 3:1, 4:2, 5:3}
testing_distance_to_vertices_2 = {0:0, 1:1, 2:1, 3:1, 4:1, 5:2, 6:2}
testing_routing_table_1 = {0:None, 1:0, 2:0, 3:0, 4:2, 5:4}
testing_routing_table_2 = {0:None, 1:0, 2:0, 3:0, 4:0, 5:1, 6:3}

# Tests : bfs
assert(bfs(0,{0 : {0 : 0}}) == ({0:0},{0:None}))
assert(bfs(0,testing_graph_1) == (testing_distance_to_vertices_1, testing_routing_table_1))
assert(bfs(0,testing_graph_2) == (testing_distance_to_vertices_2, testing_routing_table_2))

# Tests : find_route
assert(find_route(testing_routing_table_1,0,5) == [0,2,4,5])
assert(find_route(testing_routing_table_2,0,5) == [0,1,5])
