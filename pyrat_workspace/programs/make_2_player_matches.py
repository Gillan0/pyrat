...
import greedy_2 as program_1
import tournament as program_2
...
def run_one_game ( seed:      int,
    ...
    players = [{"name": program_1.__name__, "team": "1", "preprocessing_function": program_1.preprocessing if "preprocessing" in dir(program_1) else None, "turn_function": program_1.turn, "location":"random"},
               {"name": program_2.__name__, "team": "2", "preprocessing_function": program_2.preprocessing if "preprocessing" in dir(program_2) else None, "turn_function": program_2.turn, "location":"random"}]
